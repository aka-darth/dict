...
while($line=mysql_fetch_assoc($query)){
	...
	<tr>
		...
		<td>";
			if($line['showlang']){
				echo "
			<input type='radio' onclick='show(".$line['id'].");' style='border:1px solid #f00;' name='show".$line['id']."' value='0'>/<input type='radio' onclick='show(".$line['id'].");' style='border:1px solid #0f0;' checked name='show".$line['id']."' value='1'>
				";
			}else{
				echo "
			<input type='radio' onclick='show(".$line['id'].");' style='border:1px solid #f00;' checked name='show".$line['id']."' value='0'>/<input type='radio' onclick='show(".$line['id'].");' style='border:1px solid #0f0;' name='show".$line['id']."' value='1'>
				";
			}
	echo "
		</td>
